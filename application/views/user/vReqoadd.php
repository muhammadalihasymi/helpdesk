        ...
        <div class="row">
            <div class="col">
                <div class="col-lg-6" style="margin-top: 10%; margin-left: 25%">
                    ...
                    <h2 style="text-align: center; padding-bottom: 30px; font-weight: bold">Request Office Item</h2>
                        <form action="<?php echo base_url() . 'cUserreqo/tambah_aksi'; ?>" method="post">
                        <table style="margin:20px auto;">
                                ...
                                <tr>
                                    <td>Request</td>
                                    <td style="padding-bottom: 10px; padding-left: 20px">
                                        <textarea class="form-control" rows="4" cols="50%" name="exp" placeholder="Enter a Request"></textarea>
                                    </td>
                                </tr>
                                <tr>
                                    <td></td>
