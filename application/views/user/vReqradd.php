        ...
        <div class="row">
            <div class="col">
                <div class="col-lg-6" style="margin-top: 10%; margin-left: 25%">
                    ...
                    <h2 style="text-align: center; padding-bottom: 30px; font-weight: bold">Repair item</h2>
                        <form action="<?php echo base_url() . 'cUserreqr/tambah_aksi'; ?>" method="post">
                        <table style="margin:20px auto;">
                                ...
                                <tr>
                                    <td>Repair</td>
                                    <td style="padding-bottom: 10px; padding-left: 20px">
                                        <textarea class="form-control" rows="4" cols="50%" name="exp" placeholder="Enter a Repairing"></textarea>
                                    </td>
                                </tr>
                                <tr>
                                    <td></td>
