                ...
                <div class="col">
                    <div class="col-lg-6" style="margin-top: 10%; margin-left: 25%">
                        ...
                        <div class="container" style="background: #fff; padding: 50px; border-radius: 20px;">
                            <h2 style="text-align: center; padding-bottom: 30px; font-weight: bold">Request Software Item</h2>
                            <form action="<?php echo base_url() . 'cUserreqh/tambah_aksi'; ?>" method="post">
                                <table style="margin:20px auto;">
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding-bottom: 10px; padding-left: 20px">
                                            <select class="form-control" name="item">
                                                <?php
                                                foreach ($soft->result() as $j) { //result() berguna untuk mengubah query menjadi data
                                    ...
                                    <tr>
                                        <td>
                                            <input class="form-control" type="hidden" name="process" value="On Process">
                                        </td>
                                    </tr>
                                </table>
                            </form>
                            ...
                            <a href="<?= base_url('cUser'); ?>">
                                ...
                                position: absolute;
                                bottom: 20px;
                                right: 60px" href="<?= base_url('cUser'); ?>">Back to Home</a>
                                <span style="
                            position: absolute;
                            bottom: 20px;
