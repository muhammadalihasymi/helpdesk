...
<body id="page-top">
    ...
    <div class="wrapper2" style="z-index: 99">
        ...
        <h2 style=" padding-left: 30px; transform: translateY(-60px); font-weight: bold; color: rgb(0, 128, 192)">Request Hardware</h2>
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            ...
                            <th style="text-align: center; width: 200px">Option</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php foreach ($req->result() as $m) : ?>
                            <tr>
                                <td style="text-align: center;"><?php echo $m->user ?></td>
                                <td style="text-align: center;"><?php echo $m->email ?></td>
                                <td style="text-align: center;"><?php echo $m->item ?></td>
                                <td style="text-align: center;"><?php echo $m->exp ?></td>
                                <td style="text-align: center;"><?php echo $m->status ?></td>
                                <td>
                                    <a style=" margin-left: 10px ;padding-left: 20px; padding-right: 20px" href="<?php base_url() ?>cUserreqh/edit/<?php echo $m->id; ?>" class="btn btn-success">edit</a>
                                    <a style="margin-left: 10px" href="<?php base_url() ?>cUserreqh/hapus/<?php echo $m->id; ?>" class="btn btn-danger" onclick="return confirm('Apakah Anda yakin menghapus data?')">delete</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
