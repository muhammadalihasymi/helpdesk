...
<body id="page-top">
    ...
    <div class="wrapper2" style="z-index: 99">
        ...
        <h2 style=" text-align: center ; margin-bottom: 50px; font-weight: bold; color: rgb(0, 128, 192)">Edit Request Software</h2>
        ...
        <div class="col-lg-8" style="margin: auto">
            ...
            <div class="container">
                <?php foreach ($req as $m) : ?>
                    <form action="<?php echo base_url() . 'cUserreqs/update'; ?>" method="post">
                        <table style="margin:20px auto;">
                            <tr>
                                <td style="padding-bottom: 10px">
                                    <input class="form-control" type="hidden" name="id" value="<?php echo $m->id ?>">
                                </td>
                            </tr>
                            <tr>
                                <td>User</td>
                            ...
                            <tr>
                                <td>Item</td>
                                <td style="padding-bottom: 10px">
                                    <input class="form-control" type="text" name="item" value="<?php echo $m->soft ?>" readonly>
                                </td>
                            </tr>
                            <tr>
                                <td>Description</td>
        ...
        <a href="<?= base_url('cUserreqs'); ?>">
            <a style="
                    position: absolute;
                    bottom: 20px;
                    right: 50px" href="<?= base_url('cUserreqs'); ?>">Back to Request Software</a>
            <span style="
                position: absolute;
                bottom: 20px;
