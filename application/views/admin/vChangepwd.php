    ...
    <div class="wrapper">
        <div class="navbar">
            <ul class="menu">
                ...
                <li class="active">
                    <a href="<?= base_url('cAdminchangepwd'); ?>">
    ...
    <div class="wrapper2">
        ...
        <div class="col">
            <div class="col-lg-8" style="margin-left: 30px">
                <h2 style="padding-bottom: 30px">Change Password</h2>
                <?= $this->session->flashdata('message'); ?>

                <form action="<?= base_url('cAdminchangepwd'); ?>" method="POST" enctype="multipart/form-data">
        ...
        <li>
            <a href="<?= base_url('cAdminedit'); ?>">
                <a style="
                        position: absolute;
                        bottom: 20px;
                        right: 50px" href="<?= base_url('cAdmin'); ?>">Back to Home</a>
                <span style="
                    position: absolute;
                    bottom: 20px;
