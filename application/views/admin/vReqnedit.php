...
<body id="page-top">
    ...
    <div class="wrapper2" style="z-index: 99">
        ...
        <h2 style=" text-align: center ; margin-bottom: 50px; font-weight: bold; color: rgb(0, 128, 192)">Edit Request Network</h2>
        ...
        <div class="col-lg-8" style="margin: auto">
            ...
            <div class="container">
                <?php foreach ($req as $m) : ?>
                    <form action="<?php echo base_url() . 'cUserreqn/update'; ?>" method="post">
        ...
        <a href="<?= base_url('cUserreqn'); ?>">
            <a style="
                    position: absolute;
                    bottom: 20px;
                    right: 50px" href="<?= base_url('cUserreqn'); ?>">Back to Request Network</a>
            <span style="
                position: absolute;
                bottom: 20px;
