...
<body id="page-top">
    ...
    <div class="wrapper2">
        ...
        <h2 style=" text-align: center ; margin-bottom: 50px; font-weight: bold; color: rgb(0, 128, 192)">Add Software Item</h2>

        <!-- CONTENT HERE -->
        <div class="col-lg-8" style="margin: auto">
            <?= $this->session->flashdata('message'); ?>
            <div class="container">
                <form action="<?php echo base_url() . 'cItems/tambah_aksi'; ?>" method="post">
                    <table style="margin:20px auto;">
                        <tr>
                            <td>Item</td>
                            <td style="padding-bottom: 10px">
                                <input class="form-control" type="text" name="item" placeholder="Input Item">
                            </td>
                        </tr>
                        <tr>
                            <td></td>
        ...
        <a href="<?= base_url('cItems'); ?>">
            <a style="
                    position: absolute;
                    bottom: 20px;
                    right: 50px" href="<?= base_url('cItems'); ?>">Back to Software Item</a>
            <span style="
                position: absolute;
                bottom: 20px;
