        ...
        <div class="wrapper2">
            <nav class="navbar navbar-expand navbar-light topbar mb-4 static-top">
             ...
             <div class="col">
                ...
                <h2 style="padding-bottom: 30px">Edit Profile</h2>
                    <?= $this->session->flashdata('message'); ?>
                    <form action="<?= base_url('cAdminedit'); ?>" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-sm4">
            ...
            <a href="<?= base_url('cAdminedit'); ?>">
                    <a style="
                        ...
                        bottom: 20px;
                        right: 50px"
                    href="<?= base_url('cAdmin'); ?>">Back to Home</a>
                    <span style="
                    position: absolute;
                    bottom: 20px;
