...
<body id="page-top">
    ...
    <div class="wrapper2">
        ...
        <h2 style=" text-align: center ; margin-bottom: 50px; font-weight: bold; color: rgb(0, 128, 192)">Add Hardware Item</h2>
        ...
        <div class="row">
            <div class="col">
                <div class="col-lg-8" style="margin: auto">
                    ...
                    <div class="container">
                        <form action="<?php echo base_url() . 'cItemh/tambah_aksi'; ?>" method="post">
                            <table style="margin:20px auto;">
                                <tr>
                                    <td>Item</td>
                                    <td><input class="form-control" type="text" name="item" placeholder="Input Item"></td>
                                </tr>
                                <tr>
                                    <td></td>
