...
<body id="page-top">
    ...
    <div class="wrapper2" style="z-index: 99">
        ...
        <h2 style=" padding-left: 30px; transform: translateY(-60px); font-weight: bold; color: rgb(0, 128, 192)">Request Software</h2>
                ...
                <table class="table table-bordered" id="dataTable" cellspacing="0">
                    <thead>
                        <tr>
                            ...
                            <th style="text-align: center;">Software Request</th>
                    ...
                    <tbody>
                        <?php foreach ($req->result() as $m) : ?>
                            <tr>
                                ...
                                <td><?php echo $m->soft ?></td>
                                <td><?php echo $m->exp ?></td>
                                <td><?php echo $m->status ?></td>
                                <td>
                                    <a style=" margin-left: 10px ;padding-left: 20px; padding-right: 20px" href="<?php base_url() ?>cUserreqs/edit/<?php echo $m->id; ?>" class="btn btn-success ">edit</a>
                                    <a style="margin-left: 10px" href="<?php base_url() ?>cUserreqs/hapus/<?php echo $m->id; ?>" class="btn btn-danger " onclick="return confirm('Apakah Anda yakin menghapus data?')">delete</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
