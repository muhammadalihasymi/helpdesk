...
<body id="page-top">
    <div class="wrapper">
        ...
        <div class="wrapper2" style="z-index: 99">
            ...
            <h2 style=" text-align: center ; margin-bottom: 50px; font-weight: bold; color: rgb(0, 128, 192)">Edit User Data</h2>
            ...
            <div class="col-lg-8" style="margin: auto">
                        ...
                        <div class="container">
                            <?php foreach ($users as $m) : ?>
                                <form action="<?php echo base_url() . 'cAdminuser/update'; ?>" method="post">
                                    <table style="margin:20px auto;">
                                        ...
                                        <tr>
                                            <td>Full Name</td>
                                            <td style="padding-bottom: 10px">
                                                <input class="form-control" type="text" name="name" value="<?php echo $m->name ?>">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Email</td>
                                            <td style="padding-bottom: 10px">
                                                ...
                                                class="form-control" type="text" name="email" value="<?php echo $m->email ?>" readonly>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>User role</td>
                                            <td style="padding-bottom: 10px">
                                                <select class="form-control" name="role">
                                                    <?php
                                                    foreach ($role->result() as $j) {
                                                        $selected = '';
                                                        if ($j->id == $m->role_id) {
                                                            $selected = 'selected';
                                                        }
                                                        echo "<option value='" . $j->id . "' " . $selected . ">" . $j->role . "</option>";
                                                    }
                                                    ?>
                                                </select>
                                            </td>
            ...
            <a href="<?= base_url('cAdminuser'); ?>">
                <a style="
                    ...
                    bottom: 20px;
                    right: 50px"
                href="<?= base_url('cAdminuser'); ?>">Back to User Data</a>
                <span style="
                position: absolute;
                bottom: 20px;
