...
<body id="page-top">
    ...
    <div class="wrapper2">
        ...
        <h2 style=" padding-left: 35px; transform: translateY(-60px); font-weight: bold; color: rgb(0, 128, 192)">Hardware Item</h2>

        <!-- CONTENT HERE -->
        <div class="col-lg-12">
            <?= $this->session->flashdata('message'); ?>
            <div class="container table-responsive">
                <a href="<?php echo base_url(); ?>cItemh/tambah" class="btn btn-primary mb-3">Add Item</a>
                <table class="table table-bordered" id="dataTable" cellspacing="0">
                    <thead>
                        <tr>
                            <th style="text-align: center; ">Item Name</th>
                            <th style="text-align: center; width: 130px">Option</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php foreach ($itemh as $m) : ?>
                            <tr>
                                <td><?php echo $m->item ?></td>
                                <td>
                                    <a href="<?php base_url() ?>cItemh/edit/<?php echo $m->id; ?>" class="btn btn-success">edit</a>
                                    <a href="<?php base_url() ?>cItemh/hapus/<?php echo $m->id; ?>" class="btn btn-danger" onclick="return confirm('Apakah Anda yakin menghapus data?')">delete</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
