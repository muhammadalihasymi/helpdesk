 ...
 <!-- Logout Modal-->
    ...
    <div class="wrapper">
        ...
        <nav class="navbar navbar-expand navbar-light topbar static-top" style="z-index: 99">
            ...
            <h2 style=" padding-left: 35px; transform: translateY(-60px); font-weight: bold; color: rgb(0, 128, 192)">Software Item</h2>

            <!-- CONTENT HERE -->
            <div class="col-lg-12">
                        <?= $this->session->flashdata('message'); ?>
                        <div class="container table-responsive">
                            <a href="<?php echo base_url(); ?>cItems/tambah" class="btn btn-primary mb-3">Add Item</a>
                            <table class="table table-bordered" id="dataTable" cellspacing="0">
                                <thead>
                                    <tr>
                                        <th style="text-align: center;">Item Name</th>
                                        <th style="text-align: center; width: 150px">Option</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php foreach ($item as $m) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                href="<?php base_url() ?>cItems/edit/<?php echo $m->id; ?>" class="btn btn-success">edit</a>
                                                <a href="<?php base_url() ?>cItems/hapus/<?php echo $m->id; ?>" class="btn btn-danger" onclick="return confirm('Apakah Anda yakin menghapus data?')">delete</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
