...
<body id="page-top">
    ...
    <div class="wrapper2" style="z-index: 99">
        ...
        <h2 style=" padding-left: 30px; transform: translateY(-60px); font-weight: bold; color: rgb(0, 128, 192)">Request Network</h2>
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            ...
                            <th style="text-align: center;">Network Request</th>
                    ...
                    <tbody>
                        <?php foreach ($net->result() as $m) : ?>
                            <tr>
                                ...
                                <td>
                                    <a style=" margin-left: 10px ;padding-left: 20px; padding-right: 20px" href="<?php base_url() ?>cUserreqn/edit/<?php echo $m->id; ?>" class="btn btn-success">edit</a>
                                    <a style="margin-left: 10px" href="<?php base_url() ?>cUserreqn/hapus/<?php echo $m->id; ?>" class="btn btn-danger" onclick="return confirm('Apakah Anda yakin menghapus data?')">delete</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
