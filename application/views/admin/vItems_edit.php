...
<body id="page-top">
    ...
    <div class="wrapper2">
        ...
        <h2 style=" text-align: center ; margin-bottom: 50px; font-weight: bold; color: rgb(0, 128, 192)">Edit Software Item</h2>
        ...
        <div class="col-lg-8" style="margin: auto">
            ...
            <div class="container">
                <?php foreach ($item as $m) : ?>
                    <form action="<?php echo base_url() . 'cItems/update'; ?>" method="post">
