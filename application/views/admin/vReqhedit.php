...
<body id="page-top">
    ...
    <div class="wrapper2" style="z-index: 99">
        ...
        <h2 style=" text-align: center ; margin-bottom: 50px; font-weight: bold; color: rgb(0, 128, 192)">Edit Request Hardware</h2>
            ...
            <div class="col-lg-8" style="margin: auto">
                ...
                <div class="container">
                    <?php foreach ($req as $m) : ?>
                        <form action="<?php echo base_url() . 'cUserreqh/update'; ?>" method="post">
                            <table>
                                <tr>
                                    <td><input class="form-control" type="hidden" name="id" value="<?php echo $m->id ?>"></td>
                                </tr>
                                <tr>
                                    <td>User</td>
                                    <td style="padding-bottom: 10px">
                                        <input class="form-control" type="text" name="user" value="<?php echo $m->user ?>" readonly>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Email</td>
                                    <td style="padding-bottom: 10px">
                                        <input class="form-control" type="text" name="email" value="<?php echo $m->email ?>" readonly>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Item</td>
                                    <td style="padding-bottom: 10px">
                                        <input class="form-control" type="text" name="item" value="<?php echo $m->item ?>" readonly>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Description</td>
                                    <td style="padding-bottom: 10px">
                                        <textarea style="margin-left: 20px;" class="form-control" rows="4" cols="50%" name="exp" readonly><?php echo $m->exp ?></textarea>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Status</td>
                                    <td style="padding-bottom: 10px">
                                        <select class="form-control" name="stat">
                                            <option <?= ($m->status == 'On Process') ? 'selected' : ''; ?>>On Process</option>
        ...
        <a href="<?= base_url('cUserreqh'); ?>">
            <a style="
                    position: absolute;
                    bottom: 20px;
                    right: 50px" href="<?= base_url('cUserreqh'); ?>">Back to Request Hardware</a>
            <span style="
                position: absolute;
                bottom: 20px;
