...
<body id="page-top">
    <div class="wrapper">
        ...
        <div class="wrapper2" style="z-index: 99">
            ...
            <h2 style=" padding-left: 30px; transform: translateY(-60px); font-weight: bold; color: rgb(0, 128, 192)">User Data</h2>
                                ...
                                <tbody>
                                    <?php foreach ($data as $m) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a style=" margin-left: 10px ;padding-left: 20px; padding-right: 20px" 
                                                href="<?php base_url() ?>cAdminuser/edit/<?php echo $m->id; ?>" class="btn btn-success ">edit</a>
                                                <a style="margin-left: 10px" 
                                                href="<?php base_url() ?>cAdminuser/hapus/<?php echo $m->id; ?>" class="btn btn-danger " onclick="return confirm('Apakah Anda yakin menghapus data?')">delete</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
