...
<body id="page-top">
    ...
    <div class="wrapper2">
        ...
        <h2 style=" padding-left: 30px; transform: translateY(-60px); font-weight: bold; color: rgb(0, 128, 192)">Inventory Hardware</h2>

        <!-- CONTENT HERE -->
        <div class="container table-responsive">
            <a href="<?php echo base_url(); ?>cInv_hard/tambah" class="btn btn-primary mb-3">Add Item</a>
                ...
                <tbody>
                    <?php foreach ($data as $m) : ?>
                        <tr>
                            ...
                            <td><?php echo $m->con_id ?></td>
                            <td style="width: 180px">
                                <a style="margin-left: 15px" href="<?php base_url() ?>cInv_hard/edit/<?php echo $m->id_hard; ?>" class="btn btn-success">edit</a>
                                <a style="margin-left: 15px" href="<?php base_url() ?>cInv_hard/hapus/<?php echo $m->id_hard; ?>" class="btn btn-danger float-right" onclick="return confirm('Apakah Anda yakin menghapus data?')">delete</a>
                                <!-- <a href="<?php base_url() ?>cInv_hard/hapus/<?php echo $m->id_hard; ?>" 
