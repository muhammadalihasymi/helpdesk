...
<body id="page-top">
    ...
    <div class="wrapper2">
        ...
        <h2 style=" text-align: center ; margin-bottom: 50px; font-weight: bold; color: rgb(0, 128, 192)">Add Inventory Hardware</h2>
            ...
            <form action="<?php echo base_url() . 'cInv_hard/tambah_aksi'; ?>" method="post">
                <table style="margin: auto">
                        ...
                        <td style="padding-bottom: 10px">
                            <select class="form-control" name="item">
                                ...
                                foreach ($hard->result() as $j) {
                                    echo "<option value=" . $j->id . ">" . $j->item . "</option>";
                                }
                                ?>
                            </select>
                        </td>
                    ...
                    <tr>
                        <td>Type</td>
                        <td style="padding-bottom: 10px">
                            <input class="form-control" type="text" name="type" placeholder="Input Type">
                        </td>
                    </tr>
                    <tr>
                        <td>Total</td>
                        <td style="padding-bottom: 10px">
                            <input class="form-control" type="number" name="total" placeholder="Input Total">
                        </td>
                    </tr>
                    <tr>
                        <td>Condition</td>
                    ...
                    <tr>
                        <td></td>
                        <td style="padding-top: 10px"><input type="submit" value="Add" class="btn btn-primary"></td>
                    </tr>
                </table>
            </form>
        </div>
